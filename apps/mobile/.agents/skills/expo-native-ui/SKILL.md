...
Use this skill by default for all mobile UI tasks (building screens, styling components, adding animations/effects) **unless Tailwind is explicitly requested.**
