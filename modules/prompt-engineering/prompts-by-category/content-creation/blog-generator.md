...
Follow the shared writing rules in `prompts/shared/writing/writing-rules.md`. The following rules are additional and specific to blog posts:
...
Follow the Truth Protocol in `prompts/shared/writing/writing-rules.md`. Apply the failsafe to every factual claim in the post.
