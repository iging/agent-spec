...
- **Authority:** Normative group router for `modules/research-and-productivity/learning/`.
...
- **Action:** Select target sub-skill path under `modules/research-and-productivity/learning/`.
...
{
  "group": "learning",
  "target_skill": "modules/research-and-productivity/learning/build-spec-interviewer/SKILL.md"
}
```
...
- **Version:** 2.0.0
- **Changelog:**
  - `2.0.0` — Learning group router created for `modules/research-and-productivity/learning/`.
...
**Output:** Target `modules/research-and-productivity/learning/step-by-step-coach/SKILL.md`.
