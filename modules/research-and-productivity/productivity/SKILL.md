...
- **Authority:** Normative group router for `modules/research-and-productivity/productivity/`.
...
- **Action:** Select target sub-skill path under `modules/research-and-productivity/productivity/`.
...
{
  "group": "productivity",
  "target_skill": "modules/research-and-productivity/productivity/excel-data-engine/SKILL.md"
}
```
...
- **Version:** 2.0.0
- **Changelog:**
  - `2.0.0` — Productivity group router created for `modules/research-and-productivity/productivity/`.
...
**Output:** Target `modules/research-and-productivity/productivity/spreadsheet-style-formatter/SKILL.md`.
