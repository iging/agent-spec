...
- **Authority:** Normative group router for `modules/research-and-productivity/research/`.
...
- **Action:** Select target sub-skill path under `modules/research-and-productivity/research/`.
...
{
  "group": "research",
  "target_skill": "modules/research-and-productivity/research/social-sentiment-researcher/SKILL.md"
}
```
...
- **Version:** 2.0.0
- **Changelog:**
  - `2.0.0` — Research group router created for `modules/research-and-productivity/research/`.
...
**Output:** Target `modules/research-and-productivity/research/editorial-fact-checker/SKILL.md`.
