...
- **Authority:** Tier-5 normative root skill for `modules/research-and-productivity/`.
...
- **Action:** Select target sub-skill or sub-group router under `modules/research-and-productivity/`.
...
- **Version:** 2.0.0
- **Changelog:**
  - `2.0.0` — Module root router created for `modules/research-and-productivity/`.
...
**Output:** Target `modules/research-and-productivity/learning/build-spec-interviewer/SKILL.md`.
