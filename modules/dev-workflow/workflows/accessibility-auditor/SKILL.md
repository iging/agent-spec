...
- **Must not define:** Visual design language (see `skills/design-engineering/ui-design`); application state architecture (see `frontend/.agents/skills/`); general UX principles (see `shared/design/ui-ux-principles.md`).
- **Normative base:** `shared/design/ui-ux-principles.md`; WCAG 2.2 AA; `docs/anti-patterns.md`; `skills/_template/SKILL.md`; `docs/skill-standard.md`.
