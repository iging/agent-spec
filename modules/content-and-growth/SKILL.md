...
- **Authority:** Tier-5 normative root skill for `modules/content-and-growth/`.
...
| # | Dimension | Value |
|---|---|---|
| 1 | Task | Inspect prompts and dispatch matching sub-skills under `modules/content-and-growth/`. |
...
- **Validation:** Target file exists under `modules/content-and-growth/`.
...
```json
{
  ...
  "target_skill": "modules/content-and-growth/02-voice-and-humanization/humanize-ai-content.md",
...
**Output:** Phase `02-voice-and-humanization`, target `modules/content-and-growth/02-voice-and-humanization/purge-ai-giveaway-words.md`.
