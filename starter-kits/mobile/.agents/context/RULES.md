...
> **Note:** This file extends the shared rules found in `references/shared-rules.md`.
...
- **Read Shared Rules First:** All principles in `references/shared-rules.md` (TypeScript strictness, naming, SOLID, DRY/KISS, barrel files, and function design) apply here.
...
- **Workspace Progress Analysis:** When summarizing session progress or analyzing workspace changes, apply `prompts/01-progress-report.md` to produce a structured `progress-report-result.md`.
