...
- **Normative base:** `shared/writing-rules.md`; `docs/anti-patterns.md`; `skills/_template/SKILL.md`; `docs/skill-standard.md`; `references/` (core, advanced, architecture, browser-apis, debugging, frameworks, infrastructure-ci-cd, testing-patterns).
