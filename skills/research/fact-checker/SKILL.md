...
- **Normative base:** `shared/writing-rules.md`; `docs/anti-patterns.md`; `skills/_template/SKILL.md`; `docs/skill-standard.md`; `references/FACT-CHECK-WORKFLOW.md`.
...
**Output:** Consults `references/FACT-CHECK-WORKFLOW.md`. Extracts claims. Returns a report marking the 2023 launch year as FALSE (it was Nov 2022) and the superlative as IMPRECISE.
