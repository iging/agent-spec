...
- **Must not define:** File content semantics (content owners); product architecture (see `context/ARCHITECTURE.md`); documentation voice (see `shared/writing-rules.md`).
- **Normative base:** `references/ORGANIZATION-RULES.md`; `shared/writing-rules.md` for README voice; `docs/anti-patterns.md`; `skills/_template/SKILL.md`; `docs/skill-standard.md`.
