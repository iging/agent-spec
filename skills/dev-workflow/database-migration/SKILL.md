...
- **Normative base:** project `context/SCHEMA.md`; `context/ARCHITECTURE.md` data flow sections; `shared/nextjs-principles.md` and `shared/coding-principles.md` for type-sync discipline; `docs/anti-patterns.md`; `skills/_template/SKILL.md`; `docs/skill-standard.md`.
...
- **Action:** Update the ORM schema (e.g., Prisma, Drizzle, or local-first Dexie schema) with the new fields, indices, and relations. Keep branded-ID and union-literal conventions per `shared/coding-principles.md`.
