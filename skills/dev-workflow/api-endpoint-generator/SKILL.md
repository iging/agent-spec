...
- **Normative base:** project `context/SCHEMA.md`; `shared/coding-principles.md` (Zod parse-don't-validate, branded IDs); `shared/nextjs-principles.md` or `shared/javascript-principles.md` for the matching backend style; `docs/anti-patterns.md`; `skills/_template/SKILL.md`; `docs/skill-standard.md`.
...
- **Action:** Create a Zod schema to validate incoming data. Default to `.strict()`. Use `z.enum([...])` for unions and branded-ID types per `shared/coding-principles.md`.
...
- [ ] Branded IDs and union literals used per `shared/coding-principles.md`.
