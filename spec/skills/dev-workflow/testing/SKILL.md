...
- **Authority:** Normative group router for `skills/dev-workflow/testing/`.
...
- **Action:** Select target path under `skills/dev-workflow/testing/`.
...
{
  "group": "testing",
  "target_skill": "skills/dev-workflow/testing/write-a-test/SKILL.md"
}
```
...
- **Version:** 2.0.0
- **Changelog:**
  - `2.0.0` — Group router created for `skills/dev-workflow/testing/`.
...
**Output:** Target `skills/dev-workflow/testing/write-a-test/SKILL.md`.
