...
Defines HOW spreadsheets must look and behave. Layers on top of the `excel-data-engine` skill (`skills/research-and-productivity/productivity/excel-data-engine/SKILL.md`) — read that too for the openpyxl/recalc workflow. Where they conflict on style, THIS skill wins. Aim for refined, classy, and substantial layout.
