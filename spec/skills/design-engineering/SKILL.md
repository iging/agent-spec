...
- **Authority:** Normative root router for `skills/design-engineering/`.
...
- **Validation:** Target skill file exists under `skills/design-engineering/`.
...
```json
{
  ...
  "target_skill": "skills/design-engineering/02-aesthetic-engines-and-styles/anti-slop-aesthetic-tuning-engine.md",
...
- **Changelog:**
  ...
  - `1.0.0` : Initial root router creation for `skills/design-engineering/`.
...
**Output:** Target `skills/design-engineering/02-aesthetic-engines-and-styles/anti-slop-aesthetic-tuning-engine.md`.
