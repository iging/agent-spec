...
- **Normative base:** `references/meeting-types.md`; `references/dashboard-design.md`; `shared/writing/writing-rules.md`; `docs/anti-patterns.md`; `skills/_template/SKILL.md`; `docs/skill-standard.md`.
