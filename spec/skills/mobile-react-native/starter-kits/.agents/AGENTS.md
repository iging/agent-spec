...
| :--------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------- |
| [`context/references/shared-rules.md`](context/references/shared-rules.md)                     | **Core Shared Standards:** TypeScript rigor, SOLID principles, DRY/KISS, mandatory prop destructuring, logging constraints, state management hierarchy, and barrel file prohibition.                                                                                                                                           | MUST read before making any codebase modifications.                |
...
1. **Mobile Architectural Integrity:** Verify no main-thread layout animations, no plain `AsyncStorage` for JWTs, and no barrel files (per `shared-rules.md`).
...
3. **No Unverified Assumptions:** Label unverified claims as assumptions and state how to verify them.
4. **Build, Test & Verification Commands:** Use project scripts when shell capabilities are available.
