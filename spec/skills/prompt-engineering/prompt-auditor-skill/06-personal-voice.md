...
run longer than your stated rule — match how you write, or
shift toward how you want to write?" Aspirational voice is a legitimate
choice; it has to be a choice. Explicit rules win every tie the
...
- **Samples that contradict each other**: probably different registers,
  ...
  into a voice the user has never used.
