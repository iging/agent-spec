...
- Modifying or adding Markdown files in `core/`, `context/`, `docs/`, `modules/`, or `shared/`.
...
1. **Zero Banned Words:** Verify no prohibited terms listed in `shared/writing-rules.md`.
