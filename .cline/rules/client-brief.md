...
description: >-
  ...
  Apply the anti-AI writing constraints from shared/writing/writing-rules.md to the
...
- **Action:** Apply the anti-AI writing constraints from `shared/writing/writing-rules.md`. Delete puffery, negative parallelism, and banned vocabulary.
