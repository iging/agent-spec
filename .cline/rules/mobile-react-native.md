...
- **Authority:** Tier-5 normative root skill for `skills/mobile-react-native/`.
...
- **Action:** Select target sub-skill path under `skills/mobile-react-native/`.
...
**Output:** Target `skills/mobile-react-native/expo-project-structure/SKILL.md`.
