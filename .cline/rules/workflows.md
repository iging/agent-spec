...
- **Authority:** Normative group router for `skills/dev-workflow/workflows/`.
...
{
  "group": "workflows",
  "target_skill": "skills/dev-workflow/workflows/engineering-loop/blueprint-session/SKILL.md"
}
```
...
- **Version:** 2.0.0
- **Changelog:**
  - `2.0.0` — Workflows group router created for `skills/dev-workflow/workflows/`.
...
**Output:** Target `skills/dev-workflow/workflows/engineering-loop/blueprint-session/SKILL.md`.
