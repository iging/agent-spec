> [!WARNING]
> **DEPRECATED:** This is a legacy V1 standard. It contains aggressive persona scripting and anti-patterns that have since been removed. Please refer to the V2 standard (`AGENTS.md`) for active use.
